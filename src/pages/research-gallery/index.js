...
import ResearchExcellence  from '@/components/ResearchExcellence/excellence'
...
import Research_Gallery from '@/components/FacultyDashboard/Research_Gallery/Research_Gallery'
  ...
  return (
    ...
    <div className="flex  justify-between px-4 mt-4 rounded-lg">
        ...
        <div className="flex flex-col" >
         ...
         <div className='bg-div-gray flex py-2 h-10 mt-2 w-50% justify-end items-end px-2  rounded-xl '>
