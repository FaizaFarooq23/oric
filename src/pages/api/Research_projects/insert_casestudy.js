...
export default async function handler(req, res) {
    const { username, Name_of_Government_Body, Advocacy_tools, Area_advocated, Date_of_presentation, Banking_research_status, Coalation_Partner, Breif_Details, Issue_verification } = req.body;
    try {
        const policy_casestudy = await prisma.Policy_CaseStudy.create({
            data: {
                ...
                Date_of_presentation: Date_of_presentation.toISOString,
