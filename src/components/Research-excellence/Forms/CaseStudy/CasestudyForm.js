...
import { BsCheckCircle } from 'react-icons/bs'; // Import tick icon from react-icons library
import Modal, { useModalState } from "react-simple-modal-provider";
import SavedSuccessfullyModal from "@/components/Profile/components/Common/SuccessMessage";
      ...
      <div className="h-screen overflow-y-auto bg-white shadow-lg rounded-md mx-auto  my-2 px-10 w-4/5  ">
        <div className="py-2 m-2 flex flex-col gap-y-8   ">
          ...
          <div className="flex items-center justify-center w-full">
            ...
            <SavedSuccessfullyModal isOpen={showModal} onClose={() => setShowModal(false)} />
          </div>
        </div>
      </div>
    </Modal>
