...
export default function Researchprojectfeilds({ data, onDelete }) {
  ...
  const validateForm = () => {
    ...
    if (Status_of_proposal === "Approved") {
      ...
      if (!AwardLetterCopy) {
        ...
        !["image/jpeg", "image/jpg", "image/png"].includes(AwardLetterCopy.type)
      ) {
  ...
  return (
    <div className="flex flex-col bg-white shadow-lg m-4 rounded-md py-5 ">
      <div className="flex justify-end items-center mt-2  mr-4">
        <button
          onClick={() => onDelete(data.project_id, getFilenamesToDelete(data))}
        >
          <RiDeleteBin6Line className="text-red-600 cursor-pointer text-xl" />
        </button>
      </div>
      <div className={`flex justify-between  px-4 py-4 `}>
        <div className="flex flex-col w-52 m-4 gap-y-4  ">
        ...
        <div className={`flex flex-col w-48 gap-y-4 m-4  gap-x-8`}>
                        ...
                        <div className="flex flex-row ">
                          <div className="grid grid-cols-2 gap-x-16 gap-y-10 ">
                            <Dropdown
                              ...
                              handleOptionChange={
                                handleStatus_of_proposalChange
                              }
                            />
