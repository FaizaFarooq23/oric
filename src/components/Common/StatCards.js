...
export default function StatCards({ stats_data, icon, total, description, color, item_key }) {
  return (
      ...
      <div className="w-full flex flex-col gap-y-4">
        <div className="w-full flex justify-between">
          <div className="flex flex-col ">
            ...
            <span className="text-blue-900 text-3xl font-bold">{stats_data && stats_data[item_key]}</span>
          </div>{" "}
          <div
